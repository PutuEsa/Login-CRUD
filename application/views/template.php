...
<head>
    ...
    <title>ChewyGums online shop</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?=base_url()?>/assets/images/Esa.jpg" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Putu Esa</div>
                    <div class="email">iputuesaw@gmail.com</div>
